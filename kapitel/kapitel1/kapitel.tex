...
\begin{itemize}
    \item \textbf{RQ1:} How can a local-first, privacy-preserving command option retrieval system be designed and implemented to run efficiently under strict local-hardware constraints?
    \item \textbf{RQ2:} How does the proposed retrieval system perform in terms of matching accuracy and runtime efficiency?
    \item \textbf{RQ3:} How do command-line interface (CLI) users of varying expertise levels evaluate the usability, helpfulness, and perceived workflow efficiency of the system?
\end{itemize}
